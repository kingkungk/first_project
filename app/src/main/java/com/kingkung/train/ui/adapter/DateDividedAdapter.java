...
public abstract class DateDividedAdapter extends Adapter<ViewHolder> {
    ...
    private static DateFormat yearMonthFormat = new SimpleDateFormat("yyyy年M月", Locale.ENGLISH);
    ...
    private static class DateViewHolder extends ViewHolder {
        ...
        public void setDate(Date date) {
            ...
            builder.append(yearMonthFormat.format(date));
    ...
    public List<TimedItem> getAllItem() {
        List<TimedItem> items = new ArrayList<>();
        for (ItemGroup group : mGroups) {
            items.addAll(group.mItems);
        }
        return items;
    }
